...
export default function Herosec() {
  return (
    <div className="md:pb-6 md:pt-0 py-16 overflow-x-clip relative">
      <div className="container max-w-[1140px] 2xl:max-w-[1320px] px-3 mx-auto">
        <h2 data-aos="fade-up" className="text-[#F77B0B] xl:pt-40 lg:pt-32 md:pt-28  ff-helvetica text-[18.8px] md:leading-[24.22px]">
          Marc Joachim Hubrich
        </h2>
        <h1 data-aos="fade-up" className=" font-normal uppercase lg:text-6xl max-sm:pt-1 sm:text-5xl text-4xl ff-helvetica lg:leading-[77.28px] text-black">
          Now I let you <span className="lg:block"></span> go!
        </h1>
        <p data-aos="fade-up" className="text-[#4D4D4D] pt-2 sm:text-base text-sm font-poppins lg:leading-[25.6px] font-normal">
          For women who do not want to be completely dragged down by
          <span className="lg:block"></span> a SEPARATION.
        </p>
        <p data-aos="fade-up" className="text-[#4D4D4D] sm:pb-8 pb-4 sm:text-base text-sm font-poppins lg:leading-[25.6px] font-normal">
